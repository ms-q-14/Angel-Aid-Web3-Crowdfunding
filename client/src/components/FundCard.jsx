...
import { tagType, angelAidLogo } from "../assets";
    ...
    >
      ...
      <div className="flex flex-col p-4">
        <div className="flex flex-row items-center mb-[18px]">
          ...
          />
          {/* Implement Category ASAP into smart contract */}
        ...
        <div className="flex justify-between flex-wrap mt-[15px] gap-2">
          <div className="flex flex-col">
            <h4 className="font-epilogue font-semibold text-[14px] text-[#b2b3bd] leadaing-[22px]">
              {amountCollected} ETH
            </h4>
